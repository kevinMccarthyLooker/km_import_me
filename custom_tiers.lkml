...
#takes field_to_compar and spits into two groups based on the parameter selection
...
#############
#ANOTHER CUSTOM TIERS... DESCRIPTION TO FOLLOW
# Similar to above in that these are custom tiers, but allows user to choose a set bucket size vs set number of buckets
